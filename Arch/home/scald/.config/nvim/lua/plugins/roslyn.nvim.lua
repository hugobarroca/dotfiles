...
-- Note: This plugin adds Roslyn to Mason (through a non-core registry), but since it's only configured to run in cs files, that's the only place you'll see it in Mason.
return {
	{
		"seblj/roslyn.nvim",
		vscode = false,
